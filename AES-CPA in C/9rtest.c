...
void InvShiftrows(u8 S[16]) // 세로 배열
{
	u8 temp;
...
int main()
{
	u8		R10[16] = { 0xF2, 0x98, 0x3F, 0x40, 0x30, 0xED, 0xF6, 0x33, 0x04, 0x91, 0x10, 0x3F, 0xD1, 0xB1, 0x3F, 0xA1 };
	u8		R9[16] = { 0x73, 0x8D, 0x34, 0x43, 0xC2, 0x75, 0xC9, 0x73, 0x34, 0x7C, 0xE6, 0x0C, 0xD5, 0x20, 0x2F, 0x9E };
	u8		RE[16] = { 0x00, };
	u8		CT[16] = { 0xC0, 0x2A, 0x70, 0xA4, 0x10, 0x50, 0x31, 0x81, 0xFE, 0xEB, 0x5E, 0xF7, 0x45, 0x22, 0xE4, 0x68 };
